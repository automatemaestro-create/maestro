...
function champsDepuisProposition(proposition: DefinitionAgentProposee): Champs {
  return {
    ...
    // `null` — le modèle n'a rien proposé que le registre reconnaisse — devient un
    // champ vide, que le formulaire lit déjà « réglages par défaut ». C'est la
    // même absence, pas une seconde.
