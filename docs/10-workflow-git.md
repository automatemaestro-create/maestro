...
**Ce que `--concurrence > 1` dégrade aujourd'hui, et que la console annonce.** Un lot du chantier
#287 reste à faire, et le run le dit au démarrage plutôt que de le laisser découvrir :
...
La vue, elle, **n'est plus éteinte** : elle rend les N tickets en vol depuis #290 (§11.3). Chaque
ligne de ticket porte au passage **son numéro** dans le journal — sans quoi rien ne dirait, dans une
trace entrelacée, à qui appartient un « ✓ MR !99 ouverte ».
